...
def get_df(kernel_type, out_dim, data_dir, data_folder, use_meta):
    ...
    if out_dim == 9:
        ...
        df_train['diagnosis'] = df_train['diagnosis'].apply(lambda x: x.replace('nevus', 'benign'))
        df_train['diagnosis'] = df_train['diagnosis'].apply(lambda x: x.replace('BKL', 'benign'))
        df_train['diagnosis'] = df_train['diagnosis'].apply(lambda x: x.replace('unknown', 'benign'))
        df_train2['diagnosis'] = df_train2['diagnosis'].apply(lambda x: x.replace('BKL', 'benign'))
        df_train2['diagnosis'] = df_train2['diagnosis'].apply(lambda x: x.replace('NV', 'benign'))
        df_train2['diagnosis'] = df_train2['diagnosis'].apply(lambda x: x.replace('MEL', 'melanoma'))
        df_train2['diagnosis'] = df_train2['diagnosis'].apply(lambda x: x.replace('DF', 'benign'))
        df_train2['diagnosis'] = df_train2['diagnosis'].apply(lambda x: x.replace('AK', 'benign'))
        df_train2['diagnosis'] = df_train2['diagnosis'].apply(lambda x: x.replace('SCC', 'benign'))
        df_train2['diagnosis'] = df_train2['diagnosis'].apply(lambda x: x.replace('VASC', 'benign'))
        df_train2['diagnosis'] = df_train2['diagnosis'].apply(lambda x: x.replace('BCC', 'benign'))
    else:
    ...
    return df_train, df_test, meta_features, n_meta_features, mel_idx, diagnosis2idx
